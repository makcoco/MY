...
if __name__ == "__main__":
    ...
    """
        data_options {'valid': 'LINEMOD/yoghourt/test.txt',
                         'train': 'LINEMOD/yoghourt/train.txt', 
                         'diam': '0.213',
                         'tr_range': 'LINEMOD/yoghourt/training_range.txt', 
                         'backup': 'backup/yoghourt', 'num_workers': '10',
                         'mesh': 'LINEMOD/yoghourt/yoghourt.ply', 
                         'gpus': '0,1,2,3',
                          'name': 'yoghourt'}
    """
    net_options   = parse_cfg(cfgfile)[0]
    # print(parse_cfg(cfgfile))
    """[{'momentum': '0.9', 'channels': '3', 'width': '416', 'learning_rate': '0.001', 'decay': '0.0005', 'batch': '4', 
        'saturation': '1.5', 'exposure': '1.5', 'type': 'net', 'steps': '-1,50,3000,6000', 'max_batches': '80200', 
        'height': '416', 'subdivisions': '8', 'scales': '0.1,10,.1,.1', 'angle': '0', 'policy': 'steps', 'burn_in': '1000', 'hue': '.1'},
         {'activation': 'leaky', 'filters': '32', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional',
         'pad': '1', 'size': '3'}, {'size': '2', 'stride': '2', 'type': 'maxpool'}, 
         {'activation': 'leaky', 'filters': '64','stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'}, 
          {'size': '2', 'stride': '2', 'type': 'maxpool'},
           {'activation': 'leaky', 'filters': '128', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'},
            {'activation': 'leaky', 'filters': '64', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '1'},
             {'activation': 'leaky', 'filters': '128', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'}, 
             {'size': '2', 'stride': '2', 'type': 'maxpool'},
              {'activation': 'leaky', 'filters': '256', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'}, 
              {'activation': 'leaky', 'filters': '128', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '1'}, 
              {'activation': 'leaky', 'filters': '256', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'}, 
              {'size': '2', 'stride': '2', 'type': 'maxpool'},
               {'activation': 'leaky', 'filters': '512', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'}, 
              {'activation': 'leaky', 'filters': '256', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '1'},
               {'activation': 'leaky', 'filters': '512', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'},
                {'activation': 'leaky', 'filters': '256', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '1'}, 
                {'activation': 'leaky', 'filters': '512', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'}, 
                {'size': '2', 'stride': '2', 'type': 'maxpool'},
                 {'activation': 'leaky', 'filters': '1024', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'}, 
                 {'activation': 'leaky', 'filters': '512', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '1'},
                  {'activation': 'leaky', 'filters': '1024', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'}, 
                  {'activation': 'leaky', 'filters': '512', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '1'}, 
                  {'activation': 'leaky', 'filters': '1024', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'},
                   {'activation': 'leaky', 'filters': '1024', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'},
                    {'activation': 'leaky', 'filters': '1024', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'},
                     {'layers': '-9', 'type': 'route'}, 
                     {'activation': 'leaky', 'filters': '64', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '1'},
                     {'stride': '2', 'type': 'reorg'}, {'layers': '-1,-4', 'type': 'route'}, 
                     {'activation': 'leaky', 'filters': '1024', 'stride': '1', 'batch_normalize': '1', 'type': 'convolutional', 'pad': '1', 'size': '3'},
                      {'activation': 'linear', 'filters': '20', 'stride': '1', 'batch_normalize': 0, 'type': 'convolutional', 'pad': '1', 'size': '1'}, 
                      {'thresh': '.6', 'bias_match': '1', 'coord_scale': '1', 'jitter': '.3', 'absolute': '1', 'softmax': '1', 'anchors': '1.3221, 1.73145, 3.19275, 4.00944, 5.05587, 8.09892, 9.47112,
                       4.84053, 11.2364, 10.0071', 'num': '1', 'classes': '1', 'class_scale': '1', 'noobject_scale': '0.1', 'type': 'region', 'coords': '18', 'object_scale': '5', 'random': '1', 'rescore': '1'}]
    len(testlist) 25"""
    ...
    nsamples      = file_lines(trainlist) #统计有多少训练的样本书
    ...
    bg_file_names = get_all_files('VOCdevkit/VOC2012/JPEGImages')#重构的listdata类需要使用到这个

    # Train parameters
    max_epochs    = 1400 # max_batches*batch_size/nsamples+1
    use_cuda      = True
    seed          = int(time.time())
    eps           = 1e-5
    ...
    #cfgfile=cfg/yolo-pose.cfg,实例化Darknet这个类
